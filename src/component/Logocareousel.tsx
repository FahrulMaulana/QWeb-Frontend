...
import itunnes from "@/assets/pngwing.com (1).png";
import logo1 from "@/assets/pngwing.com (3).png";
import logo2 from "@/assets/pngwing.com (5).png";
import logo3 from "@/assets/pngwing.com (7).png";
...
const SpotifyIcon: React.ComponentType<React.SVGProps<SVGSVGElement>> = (props) => {
  return <img src={spotify} alt="Spotify" {...props} />;
};

const ItunesIcon: React.ComponentType<React.SVGProps<SVGSVGElement>> = (props) => (
  <img src={itunnes} alt="iTunes" {...props} />
);

const LogoIcon1: React.ComponentType<React.SVGProps<SVGSVGElement>> = (props) => (
  <img src={logo1} alt="Logo 1" {...props} />
);

const LogoIcon2: React.ComponentType<React.SVGProps<SVGSVGElement>> = (props) => (
  <img src={logo2} alt="Logo 2" {...props} />
);

const LogoIcon3: React.ComponentType<React.SVGProps<SVGSVGElement>> = (props) => (
  <img src={logo3} alt="Logo 3" {...props} />
);
...
const allLogos = [
  ...
  { name: "Spotify", id: 15, img: SpotifyIcon},
  { name: "iTunes", id: 16, img: ItunesIcon },
  { name: '17', id: 17, img: LogoIcon1 },
  { name: '18', id: 18, img: LogoIcon2},
  { name: '19', id: 19, img: LogoIcon3 },
